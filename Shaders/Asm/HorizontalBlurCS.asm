...
ilt r0.x, vThreadIDInGroup.x, cb0[0].x
if_nz r0.x
  ...
  store_structured g0.xyzw, vThreadIDInGroup.x, l(0), r0.xyzw
endif 
ineg r0.x, cb0[0].x
iadd r0.y, r0.x, l(256)
ige r0.y, vThreadIDInGroup.x, r0.y
if_nz r0.y
  iadd r0.y, vThreadID.x, cb0[0].x
  resinfo_indexable(texture2d)(float,float,float,float)_uint r0.z, l(0), t0.yzxw
  iadd r0.z, r0.z, l(-1)
  umin r1.x, r0.z, r0.y
  ishl r0.y, cb0[0].x, l(1)
  iadd r0.y, r0.y, vThreadIDInGroup.x
...
iadd r0.y, vThreadIDInGroup.x, cb0[0].x
