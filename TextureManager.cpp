...
void CTextureManager::LoadTextures()
{
	...
	vector<wstring> texFilenames =
	{
		...
		L"Asset\\Textures\\Plane_00_Diffuse.dds", // HeightMap‚Ì‚ ‚éTextures‚ğ‚±‚±‚©‚ç‡Ÿ’Ç‰Á
		...
		L"Asset\\Textures\\Plane_00_Normal.dds", // NormalMap(With Height)‚ğ‚±‚±‚©‚ç‡Ÿ’Ç‰Á

		L"Asset\\Textures\\Plane_00_Height.dds", // HeightMap‚ğ‚±‚±‚©‚ç‡Ÿ’Ç‰Á 
